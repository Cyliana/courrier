 ...
 */
final class Version20211104145456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE suivi (id INT AUTO_INCREMENT NOT NULL, precedent_id INT DEFAULT NULL, suivant_id INT DEFAULT NULL, courrier_id INT NOT NULL, date DATETIME NOT NULL, objet VARCHAR(255) NOT NULL, commentaire LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_2EBCCA8F4F6564F9 (precedent_id), UNIQUE INDEX UNIQ_2EBCCA8F9C2BB0CC (suivant_id), INDEX IDX_2EBCCA8F8BF41DC7 (courrier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
